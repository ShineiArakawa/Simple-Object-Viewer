...
ImGuiSceneWindow::ImGuiSceneWindow(GLFWwindow* parentWindow, pRenderer renderer) {
...
ImGuiSceneWindow::pFrameBuffer ImGuiSceneWindow::getFrameBuffer() {
  return _frameBuffer;
}

void ImGuiSceneWindow::resetCameraPose() {
...
void ImGuiSceneWindow::resizeGL(const int& width, const int& height) {
  WIN_WIDTH = width;
  WIN_HEIGHT = height;
...
glm::vec3 ImGuiSceneWindow::getVector(const double& x, const double& y) {
...
void ImGuiSceneWindow::updateRotate() {
...
void ImGuiSceneWindow::updateTranslate() {
  // NOTE:
...
void ImGuiSceneWindow::updateScale() { _renderer->updateScale(acScale); }

void ImGuiSceneWindow::updateTransform() {
  switch (arcballMode) {
...
void ImGuiSceneWindow::mouseEvent(const bool& isMouseOnScene, const ImVec2& relMousePos) {
...
void ImGuiSceneWindow::motionEvent(const bool& isMouseOnScene, const ImVec2& relMousePos) {
  if (isDragging) {
    newPos = relMousePos;
...
void ImGuiSceneWindow::wheelEvent(const bool& isMouseOnScene, const float& offset) {
  if (isMouseOnScene) {

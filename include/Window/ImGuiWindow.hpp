...
class ImGuiWindowHandler {
 public:
  ...
  // Default Variables ======================================================
  // ========================================================================
  inline static const int WIN_WIDTH = 1024;
  inline static const int WIN_HEIGHT = 1024;
  ...
  inline static GLuint textureBufferID;
  inline static GLuint frameBufferID;
  inline static GLuint depthBufferID;
  // ========================================================================
  // ========================================================================
  // ========================================================================
